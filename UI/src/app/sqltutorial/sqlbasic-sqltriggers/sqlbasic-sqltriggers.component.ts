...
@Component({
  selector: 'app-sqlbasic-sqltriggers',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-sqltriggers.component.html',
  styleUrl: './sqlbasic-sqltriggers.component.css'
})
export class SqlbasicSqltriggersComponent {
  currentPath: string = '';
