...
@Component({
  selector: 'app-sqlbasic-sqlpartitioning',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-sqlpartitioning.component.html',
  styleUrl: './sqlbasic-sqlpartitioning.component.css'
})
export class SqlbasicSqlpartitioningComponent {
  currentPath: string = '';
