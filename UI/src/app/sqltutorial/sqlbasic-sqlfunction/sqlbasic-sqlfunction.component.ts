...
@Component({
  selector: 'app-sqlbasic-sqlfunction',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-sqlfunction.component.html',
  styleUrl: './sqlbasic-sqlfunction.component.css'
})
export class SqlbasicSqlfunctionComponent {
  currentPath: string = '';
