...
@Component({
  selector: 'app-sqlbasic-sql-operators',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-sql-operators.component.html',
  styleUrl: './sqlbasic-sql-operators.component.css'
})
export class SqlbasicSqlOperatorsComponent {
  currentPath: string = '';
