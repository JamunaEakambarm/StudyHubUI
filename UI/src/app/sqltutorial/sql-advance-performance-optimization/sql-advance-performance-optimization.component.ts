...
@Component({
  selector: 'app-sql-advance-performance-optimization',
  imports: [MatCardModule,CommonModule,MatExpansionModule],
  templateUrl: './sql-advance-performance-optimization.component.html',
  styleUrl: './sql-advance-performance-optimization.component.css'
})
export class SqlAdvancePerformanceOptimizationComponent {
  currentPath: string = '';
