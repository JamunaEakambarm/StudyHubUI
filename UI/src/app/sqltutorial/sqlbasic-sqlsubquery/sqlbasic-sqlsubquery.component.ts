...
@Component({
  selector: 'app-sqlbasic-sqlsubquery',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-sqlsubquery.component.html',
  styleUrl: './sqlbasic-sqlsubquery.component.css'
})
export class SqlbasicSqlsubqueryComponent {
