...
@Component({
  selector: 'app-sqlbasic-sqltransactions',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-sqltransactions.component.html',
  styleUrl: './sqlbasic-sqltransactions.component.css'
})
export class SqlbasicSqltransactionsComponent {
  currentPath: string = '';
