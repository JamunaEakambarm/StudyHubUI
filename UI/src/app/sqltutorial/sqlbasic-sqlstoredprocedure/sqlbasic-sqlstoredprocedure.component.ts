...
@Component({
  selector: 'app-sqlbasic-sqlstoredprocedure',
  imports: [MatCard,MatCardModule,MatExpansionModule, CommonModule],
  templateUrl: './sqlbasic-sqlstoredprocedure.component.html',
  styleUrl: './sqlbasic-sqlstoredprocedure.component.css'
})
export class SqlbasicSqlstoredprocedureComponent {
