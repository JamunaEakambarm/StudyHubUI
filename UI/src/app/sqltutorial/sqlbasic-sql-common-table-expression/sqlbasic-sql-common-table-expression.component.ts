...
@Component({
  selector: 'app-sqlbasic-sql-common-table-expression',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-sql-common-table-expression.component.html',
  styleUrl: './sqlbasic-sql-common-table-expression.component.css'
})
export class SqlbasicSqlCommonTableExpressionComponent {
  currentPath: string = '';
