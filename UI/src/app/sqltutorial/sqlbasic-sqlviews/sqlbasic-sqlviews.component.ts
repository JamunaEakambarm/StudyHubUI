...
@Component({
  selector: 'app-sqlbasic-sqlviews',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-sqlviews.component.html',
  styleUrl: './sqlbasic-sqlviews.component.css'
})
export class SqlbasicSqlviewsComponent {
  currentPath: string = '';
