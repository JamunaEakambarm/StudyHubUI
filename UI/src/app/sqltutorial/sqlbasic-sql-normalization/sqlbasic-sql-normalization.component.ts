...
@Component({
  selector: 'app-sqlbasic-sql-normalization',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-sql-normalization.component.html',
  styleUrl: './sqlbasic-sql-normalization.component.css'
})
export class SqlbasicSqlNormalizationComponent {
  currentPath: string = '';
