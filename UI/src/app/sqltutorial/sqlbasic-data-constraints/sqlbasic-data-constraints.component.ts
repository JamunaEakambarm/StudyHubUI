...
@Component({
  selector: 'app-sqlbasic-data-constraints',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-data-constraints.component.html',
  styleUrl: './sqlbasic-data-constraints.component.css'
})
export class SqlbasicDataConstraintsComponent {
  currentPath: string = '';
