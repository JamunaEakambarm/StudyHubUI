...
@Component({
  selector: 'app-sql-advance-sequrityinsql-encriptmask',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sql-advance-sequrityinsql-encriptmask.component.html',
  styleUrl: './sql-advance-sequrityinsql-encriptmask.component.css'
})
export class SqlAdvanceSequrityinsqlEncriptmaskComponent {
  currentPath: string = '';
