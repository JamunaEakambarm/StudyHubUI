...
@Component({
  selector: 'app-sqlbasic-sqlindexes',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-sqlindexes.component.html',
  styleUrl: './sqlbasic-sqlindexes.component.css'
})
export class SqlbasicSqlindexesComponent {
  currentPath: string = '';
