...
@Component({
  selector: 'app-sqlbasic-sqlrecursivequery',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './sqlbasic-sqlrecursivequery.component.html',
  styleUrl: './sqlbasic-sqlrecursivequery.component.css'
})
export class SqlbasicSqlrecursivequeryComponent {
  currentPath: string = '';
