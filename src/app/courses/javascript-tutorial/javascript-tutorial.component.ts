...
@Component({
  selector: 'app-javascript-tutorial',
  imports: [MatExpansionModule, CommonModule,MatCardModule],
  templateUrl: './javascript-tutorial.component.html',
  styleUrl: './javascript-tutorial.component.css'
})
export class JavascriptTutorialComponent {
